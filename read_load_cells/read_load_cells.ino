...
void setup() {
  ...
  //calibrationValue_1 = 1; //696.0; // uncomment this if you want to set this value in the sketch
  //calibrationValue_2 = 1; //733.0; // uncomment this if you want to set this value in the sketch
  ...
  //prevent hx711 from smoothing data
...
void loop() {
  static boolean newDataReady1 = true;
  static boolean newDataReady2 = true;
  const int serialPrintInterval = 10; //increase value to slow down serial print activity

  // check for new data/start next conversion:
  if (LoadCell_1.update()) newDataReady1 = true;
  if (LoadCell_2.update()) newDataReady2 = true;
  //LoadCell_1.update();
  //LoadCell_2.update();
  //newDataReady = true;
  //if ((taring1 or taring2)) {
  //  newDataReady = false;
  //}

  
  //get smoothed value from data set
  if ((newDataReady1 and newDataReady2)) {
  ...
  if (LoadCell_1.getTareStatus() == true) {
    taring1 = false;
    //Serial.println("Tare_1_complete");
  }
  if (LoadCell_2.getTareStatus() == true) {
    taring2 = false;
    //Serial.println("Tare_2_complete");
  }
